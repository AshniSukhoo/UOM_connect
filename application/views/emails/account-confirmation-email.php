                                                        ...
                                                        <tbody><tr>
                                                            <td valign="top" class="textContent">
                                                                ...
                                                                <div style="text-align:justify;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                    <br/>
                                                                    Thank you for signing up to UOM-Connect, first social network and student platform for students and lecturers of UOM.
                                                                    <br/><br/>
                                                                    Your account has successfully been created, please Click on the confirmation button below to activate your account.
                                                                    <br/><br>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3B5999;">
                                            <tbody><tr>
                                                <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                                    <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="<?=$comfirmationLink?>" target="_blank">Confirmation</a>
                                                </td>
                                            </tr>
                                            </tbody></table>
                                        <!-- // CONTENT TABLE -->
