<div class="panel panel-default">
    ...
    <?php if($profileOwner->is($this->auth->user())): ?>
        <div class="panel-footer">
            <div class="row">
                <div class="col-md-12">
                    <a href="<?=base_url()?>lecturer-profile/<?=$profileOwner->id?>/add-work" class="btn btn-primary pull-right">
                        <i class="fa fa-plus-square"></i> Add work
                    </a>
                    <a href="<?=base_url()?>lecturer-profile/<?=$profileOwner->id?>/add-education" class="btn btn-primary pull-right" style="margin-right: 10px;">
