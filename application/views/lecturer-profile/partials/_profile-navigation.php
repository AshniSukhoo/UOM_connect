<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#lecturer-profile-nav" aria-expanded="false">
        ...
        <div class="collapse navbar-collapse" id="lecturer-profile-nav">
            <ul class="nav navbar-nav">
                <li <?=(isset($profileMenu) && $profileMenu == 1)?'class="active"':''?>>
                    <a href="<?=base_url()?>lecturer-profile/<?=$profileOwner->id?>/timeline">
                ...
                <li <?=(isset($profileMenu) && $profileMenu == 2)?'class="active"':''?>>
                    <a href="<?=base_url()?>lecturer-profile/<?=$profileOwner->id?>/about">
