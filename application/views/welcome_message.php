        ...
        <div class="well">
            <form class="form">
                ...
                <div class="input-group text-center">
                    ...
                    <span class="input-group-btn"><button id="ok-button" class="btn btn-lg btn-primary" type="button">OK</button></span>
                </div>
            </form>
        </div>
                ...
                <form>
                    <div class="input-group">
                        <div class="input-group-btn">
                            <button class="btn btn-default">+1</button><button class="btn btn-default"><i class="fa fa-share"></i></button>
                        </div>
...
<?php include('template/_closing-body.php'); ?>
